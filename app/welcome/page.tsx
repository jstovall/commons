...
export default function WelcomePage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col px-6 py-10">
      <span className="commons-heading self-center text-4xl">commons</span>
      ...
      <div className="commons-card-flat mt-4 p-5">
        ...
        <p className="mb-3 text-sm">
          If you&apos;re okay with that shared risk and responsibility and
          feel like you can be a good neighbor, click install to begin!
        </p>
        ...
        {isStandalone ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="font-mono text-xs">
              On iPhone: tap the Share icon <strong>⬆️</strong> in Safari,
